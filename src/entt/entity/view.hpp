...
public:
     ...
     */
    template<typename Func>
    std::enable_if_t<std::is_invocable_v<Func, entity_type, std::add_lvalue_reference_t<Component>>, void>
     ...
     */
    template<typename Func>
    std::enable_if_t<std::is_invocable_v<Func, std::add_lvalue_reference_t<Component>>, void>
    each(Func func) const {
